...
class AdvancedImageFilterApp:
    ...
    def create_ui(self):
        ...
        filter_buttons = [
            ...
            ("Guardar Imagen", self.save_image)  # Botón nuevo
        ]
    ...
    def save_image(self):
        ...
        original_filename = self.files[self.current_index]
        name, ext = os.path.splitext(original_filename)
        new_filename = f"{name}_procesada{ext}"
        save_path = os.path.join(self.input_folder, new_filename)
...
if __name__ == "__main__":
    root = Tk()
    input_folder = r"C:\Users\AnTrAx\Desktop"
